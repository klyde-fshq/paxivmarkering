        ...
        <div className="grid md:grid-cols-3 gap-[16px]">
          <div className="gap-[10px] px-[26px] py-[39px] rounded-[14px] bg-[#FFF6E2]">
            <div className="grid grid-2 gap-[32px]">
              ...
              />
              <div className="flex flex-col gap-[16px]">
                <h1 className="text-[18px] font-bold leading-[28px] align-middle">
                  All-In-One
                </h1>
                <p className="text-[16px] leading-[26px] tracking-[2%]">
                  Your all-in-one solution for real estate—PAXIV puts you in
                  control of every step, from discovery to closing.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="gap-[10px] px-[26px] py-[39px] rounded-[14px] bg-[#FFF6E2]">
            <div className="grid grid-2 gap-[32px]">
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <p className="text-[16px] leading-[26px] tracking-[2%]">
                  We’re not a broker. We provide the platform, the data, and the
                  AI—so you stay in control of every deal.
                </p>
              </div>
            </div>
          </div>
          ...
          <div className="gap-[10px] px-[26px] py-[39px] rounded-[14px] bg-[#FFF6E2]">
            <div className="grid grid-2 gap-[32px]">
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <p className="text-[16px] leading-[26px] tracking-[2%]">
                  PAXIV delivers scalable, enterprise-grade solutions tailored
        ...
        <div className="grid md:grid-cols-2 gap-[10px]">
          <div className="flex flex-col gap-[16px] px-[26px] py-[39px] rounded-[14px] bg-[#FFF6E2]">
            <div className="grid grid-2 gap-[32px]">
              ...
              <div className="flex flex-col gap-[16px]">
                ...
                <p className="text-[16px] leading-[26px] tracking-[2%]">
                  PAXIV’s AI works for you—delivering better opportunities in
          ...
          <div className="flex flex-col gap-[10px] px-[26px] py-[39px] rounded-[14px] bg-[#FFF6E2]">
            ...
            <div className="flex flex-col gap-[16px]">
              ...
              <p className="text-[16px] leading-[26px] tracking-[2%]">
                PAXIV’s secure architecture combines encrypted storage, granular
                access permissions, and active threat detection to ensure your
                data remains private and fully protected.
              </p>
            </div>
          </div>
        </div>

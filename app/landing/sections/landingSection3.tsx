...
export default function LandingSection3() {
  return (
    <div className="flex flex-col bg-yellow-100 gap-[10px] pt-[20px] pb-[60px] px-[50px] sm:pt-[50px] sm:pb-[100px] sm:px-[100px] justify-center items-center">
      ...
      <div className="grid lg:grid-cols-[1fr_2fr] gap-[38px] md:gap-[24px] lg:gap-[250px]">
        ...
        <div className="text-[24px] gap-[24px] md:gap-[32px] leading-[36px]">
          <p className="">
            ...
            powered by AI for instant, precise result. No more switching systems
            or hunting across multiple sites.
          </p>

          <div className="">
            <li>
              <p>
                <span className="font-bold">All-in-One Access</span> — Zoning,
                ownership, comps, water rights, and more.
              </p>
            </li>
            <li>
              <p>
                <span className="font-bold">AI Precision</span> — Instantly find
                parcels that match your exact criteria.
              </p>
            </li>
            <li>
              <p>
                <span className="font-bold">Faster Decisions</span> — Go from
                search to action in seconds.
              </p>
            </li>
          </div>

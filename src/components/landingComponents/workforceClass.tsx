...
export default function WorkforceClass() {
    ...
    return (
        <div>
            <h2 className="text-[24px] align-middle text-yellow-500">Workforce Class</h2>
            <div className="flex flex-col gap-[18px]">
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-yellow-500 h-[18px] w-[1076px]" />
                </div>
                <div>
                    <div className="flex gap-[8px] text-[12px]">
                    ...
                    <div className="bg-yellow-500 h-[18px] w-[17px]" />
                </div>
                <div>
                    <div className="flex gap-[8px] text-[12px]">
                    ...
                    <div className="bg-yellow-500 h-[18px] w-[13px]" />
                </div>
                <div>
                    <div className="flex gap-[8px] text-[12px]">
                    ...
                    <div className="bg-yellow-500 h-[18px] w-[53px]" />
                </div>
                <div>
                    <div className="flex gap-[8px] text-[12px]">
                    ...
                    <div className="bg-yellow-500 h-[18px] w-[43px]" />
                </div>

...
export default function Occupation() {
    ...
    return (
        <div className="gap-[10px] md:gap-[16px]">
            <h2 className="text-[18px] md:text-[24px] align-middle text-[#FFAA20]">Occupation</h2>
            <div className="flex flex-col gap-[18px]">
                ...
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-[#FFC657] h-[18px] w-[230px] md:w-[665px]" />
                </div>
                ...
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-[#FFC657] h-[18px] w-[33px] md:w-[297px]" />
                </div>
                ...
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-[#FFC657] h-[18px] w-[33px] md:w-[178px]" />
                </div>
                ...
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-[#FFC657] h-[18px] w-[82px] md:w-[166px]" />
                </div>
                ...
                <div className="flex flex-col gap-[8px] ">
                    ...
                    <div className="bg-[#FFC657] h-[18px] w-[82px] md:w-[113px]" />
                </div>
                ...
                <div className="text-gray-500">
                    ...
                    <div className="flex md:hidden place-content-between">
                        {money2.map((money, index) => (
                            <div key={index} className="flex flex-col justify-center items-center">
                                <div className="border-[1px] h-[8px] w-[0px]" />
                                <h1>{money}</h1>
                            </div>
